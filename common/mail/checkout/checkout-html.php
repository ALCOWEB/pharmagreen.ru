...
<div class="password-reset">
    ...
    <?php if ($order->canBePaid()): ?>
        ...
        <div>
            ...
            <?= Html::a('Оплатить через Онлайн', Yii::$app->urlManager->createAbsoluteUrl(['payment/robokassa/invoice', 'id' => $order->id]), ['class' => 'btn btn-success', 'style' => 'text-decoration: none;
    color: #fff;
