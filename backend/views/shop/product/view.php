...
<div class="user-view">
    ...
    <p>
        ...
        <?php if ($product->isNew()): ?>
            <?= Html::a('Не новинка', ['not-new', 'id' => $product->id], ['class' => 'btn btn-primary', 'data-method' => 'post']) ?>
        <?php else: ?>
            <?= Html::a('Новинка', ['new', 'id' => $product->id], ['class' => 'btn btn-success', 'data-method' => 'post']) ?>
        <?php endif; ?>
        <?php if ($product->isSale()): ?>
            <?= Html::a('Нет Скидки', ['not-sale', 'id' => $product->id], ['class' => 'btn btn-primary', 'data-method' => 'post']) ?>
        <?php else: ?>
            <?= Html::a('Скидка', ['sale', 'id' => $product->id], ['class' => 'btn btn-success', 'data-method' => 'post']) ?>
        <?php endif; ?>
    </p>
    ...
    <div class="box">
        <div class="box-header with-border">Короткое описание</div>
        <div class="box-body">
            <?= Yii::$app->formatter->asNtext($product->short_desc)?>
        </div>
    </div>
    <div class="box">
        <div class="box-header with-border">способы применения</div>
        <div class="box-body">
            <?= Yii::$app->formatter->asHtml($product->application_methods, [
